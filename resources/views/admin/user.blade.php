            ...
            <div class="card-body">
                ...
                <form id="tambahForm" class="hidden-form row g-3">
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="password" name="pass" id="pass" class="form-control" placeholder="Masukkan password" autocomplete="off">
                    </div>
                    <div class="col-md-6">
                      <label for="confirm" class="form-label">Konfirmasi Password</label>
                      <input type="password" name="confirm" id="confirm" class="form-control" placeholder="Ulangi password" autocomplete="off">
                    </div>
                    <div class="col-md-6">
                      <label for="role" class="form-label">Role</label>
                      <select name="id_role" id="role" class="select-role form-select" required>
