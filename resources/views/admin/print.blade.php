...
<head>
    ...
    <style>
        ...
        /* Menyamakan lebar kolom tanda tangan */
        td[colspan="2"] {
            width: 50%;
        }
...
<body>
    <div class="container">
        ...
        <p>Dengan ini kami mohon untuk menyerahkan barang, sbb :</p>
        ...
        <p>Atas nama {{ $row }}, mohon barang tersebut diserahkan kepada:</p>
        ...
        <p>Demikianlah surat jalan ini kami buat, dan dapat dipergunakan sebagaimana mestinya.</p>
