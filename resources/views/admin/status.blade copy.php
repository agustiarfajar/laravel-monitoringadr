                      ...
                      @foreach($pengiriman as $row)
                        <tr>
                          ...
                          <td>
                            ...
                            <button class="btn btn-warning btn-sm printButton {{ ($row->status == 'dibatalkan') ? 'disabled' : '' }}" onclick="printPemasok({{ $row->id }})" data-id="{{ $row->id }}"><i class="bi bi-printer"></i></button>
