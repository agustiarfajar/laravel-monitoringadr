                    ...
                    <table class="datatable" id="tabel_item">
                        ...
                        <tr>
                            ...
                            <td>
                              ...
                              <button type="button" class="btn btn-danger btn-sm btnDelete {{ ($jml_detail_ho > 0) ? 'disabled' : '' }}" data-id="{{ $row->id }}" onclick="konfirmasiHapus({{ $row->id }})"><i class="bi bi-trash"></i></button>
                            </td>
                        </tr>
                        @endforeach
