                ...
                <div class="card info-card acc-card">
                    ...
                    <div class="filter">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                            ...
                            <li><a class="dropdown-item filter-periode-barang-masuk" data-periode="today"
                                    data-text="| Today" style="cursor:pointer">Today</a></li>
                            <li><a class="dropdown-item filter-periode-barang-masuk" data-periode="month"
                                    data-text="| This Month" style="cursor:pointer">This Month</a></li>
                            <li><a class="dropdown-item filter-periode-barang-masuk" data-periode="year"
                                    data-text="| This Year" style="cursor:pointer">This Year</a></li>
                        </ul>
                    </div>

                    <div class="card-body">
                        <h5 class="card-title">Barang Masuk <span class="txtBarangMasuk">| This Month</span> <i
                                class="bi bi-info-circle" data-bs-toggle="tooltip" data-bs-placement="top"
                                title="Total jumlah barang dalam Qty yang diterima di HO"></i></h5>
                ...
                <div class="card info-card letter-card">
                    ...
                    <div class="filter">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                            ...
                            <li><a class="dropdown-item filter-periode-barang-keluar" data-periode="today"
                                    data-text="| Today" style="cursor:pointer">Today</a></li>
                            <li><a class="dropdown-item filter-periode-barang-keluar" data-periode="month"
                                    data-text="| This Month" style="cursor:pointer">This Month</a></li>
                            <li><a class="dropdown-item filter-periode-barang-keluar" data-periode="year"
                                    data-text="| This Year" style="cursor:pointer">This Year</a></li>
                        </ul>
                    </div>

                    <div class="card-body">
                        <h5 class="card-title">Barang Keluar <span class="txtBarangKeluar">| This Month</span> <i
                                class="bi bi-info-circle" data-bs-toggle="tooltip" data-bs-placement="top"
                                title="Jumlah barang dalam Qty yang sudah keluar dari HO"></i></h5>
                ...
                <div class="card info-card sales-card">
                    ...
                    <div class="filter">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                            ...
                            <li><a class="dropdown-item filter-periode-barang-ho" data-periode="today" data-text="| Today"
                                    style="cursor:pointer">Today</a></li>
                            <li><a class="dropdown-item filter-periode-barang-ho" data-periode="month"
                                    data-text="| This Month" style="cursor:pointer">This Month</a></li>
                            <li><a class="dropdown-item filter-periode-barang-ho" data-periode="year"
                                    data-text="| This Year" style="cursor:pointer">This Year</a></li>
                        </ul>
                    </div>

                    <div class="card-body">
                        <h5 class="card-title">Sisa Barang <span class="txtSisaBarangHoPeriode">| This Month</span> <i
                                class="bi bi-info-circle" data-bs-toggle="tooltip" data-bs-placement="top"
                                title="Jumlah barang dalam Qty yang belum keluar dari HO"></i></h5>
                ...
                <div class="card info-card void-card">
                    ...
                    <div class="filter">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                            ...
                            <li><a class="dropdown-item filter-periode-barang-aging" data-periode="today"
                                    data-text="| Today" style="cursor:pointer">Today</a></li>
                            <li><a class="dropdown-item filter-periode-barang-aging" data-periode="month"
                                    data-text="| This Month" style="cursor:pointer">This Month</a></li>
                            <li><a class="dropdown-item filter-periode-barang-aging" data-periode="year"
                                    data-text="| This Year" style="cursor:pointer">This Year</a></li>
                        </ul>
                    </div>
                ...
                <div class="card info-card sales-card">
                    ...
                    <div class="filter">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                            ...
                            <li><a class="dropdown-item filter-periode-surat-jalan" data-periode="today"
                                    data-text="| Today" style="cursor:pointer">Today</a></li>
                            <li><a class="dropdown-item filter-periode-surat-jalan" data-periode="month"
                                    data-text="| This Month" style="cursor:pointer">This Month</a></li>
                            <li><a class="dropdown-item filter-periode-surat-jalan" data-periode="year"
                                    data-text="| This Year" style="cursor:pointer">This Year</a></li>
                        </ul>
                    </div>

                    <div class="card-body">
                        <h5 class="card-title">Surat Pengiriman <span class="txtSuratJalan">| This Month</span> <i
                                class="bi bi-info-circle" data-bs-toggle="tooltip" data-bs-placement="top"
                                title="Total pengiriman berdasarkan status pengiriman dari HO dan Pemasok"></i></h5>
                ...
                <div class="card info-card acc-card">
                    ...
                    <div class="filter">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                            ...
                            <li><a class="dropdown-item filter-periode-belum-kirim-pemasok" data-periode="today"
                                    data-text="| Today" style="cursor:pointer">Today</a></li>
                            <li><a class="dropdown-item filter-periode-belum-kirim-pemasok" data-periode="month"
                                    data-text="| This Month" style="cursor:pointer">This Month</a></li>
                            <li><a class="dropdown-item filter-periode-belum-kirim-pemasok" data-periode="year"
                                    data-text="| This Year" style="cursor:pointer">This Year</a></li>
                        </ul>
                    </div>

                    <div class="card-body">
                        <h5 class="card-title">Diproses <span class="txtBelumKirimPemasok">| This Month</span> <i
                                class="bi bi-info-circle" data-bs-toggle="tooltip" data-bs-placement="top"
                                title="Pengiriman yang dibuat dari HO dan Pemasok"></i></h5>
                ...
                <div class="card info-card letter-card">
                    ...
                    <div class="filter">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                            ...
                            <li><a class="dropdown-item filter-periode-belum-terima-site" data-periode="today"
                                    data-text="| Today" style="cursor:pointer">Today</a></li>
                            <li><a class="dropdown-item filter-periode-belum-terima-site" data-periode="month"
                                    data-text="| This Month" style="cursor:pointer">This Month</a></li>
                            <li><a class="dropdown-item filter-periode-belum-terima-site" data-periode="year"
                                    data-text="| This Year" style="cursor:pointer">This Year</a></li>
                        </ul>
                    </div>

                    <div class="card-body">
                        <h5 class="card-title">Dikirim <span class="txtBelumTerimaSite">| This Month</span> <i
                                class="bi bi-info-circle" data-bs-toggle="tooltip" data-bs-placement="top"
                                title="Pengiriman yang dilakukan Pemasok"></i></h5>
                ...
                <div class="card info-card confirm-card">
                    ...
                    <div class="filter">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                            ...
                            <li><a class="dropdown-item filter-periode-batal-proses" data-periode="today"
                                    data-text="| Today" style="cursor:pointer">Today</a></li>
                            <li><a class="dropdown-item filter-periode-batal-proses" data-periode="month"
                                    data-text="| This Month" style="cursor:pointer">This Month</a></li>
                            <li><a class="dropdown-item filter-periode-batal-proses" data-periode="year"
                                    data-text="| This Year" style="cursor:pointer">This Year</a></li>
                        </ul>
                    </div>

                    <div class="card-body">
                        <h5 class="card-title">Diterima <span class="txtBatalProses">| This Month</span> <i
                                class="bi bi-info-circle" data-bs-toggle="tooltip" data-bs-placement="top"
                                title="Pengiriman dari HO dan Pemasok yang sudah selesai"></i></h5>
                ...
                <div class="card">
                    <div class="filter">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                            ...
                            <li><a class="dropdown-item filter-periode-pengiriman-chart" data-periode="today"
                                    data-text="| Today" style="cursor:pointer">Today</a></li>
                            <li><a class="dropdown-item filter-periode-pengiriman-chart" data-periode="month"
                                    data-text="| This Month" style="cursor:pointer">This Month</a></li>
                            <li><a class="dropdown-item filter-periode-pengiriman-chart" data-periode="year"
                                    data-text="| This Year" style="cursor:pointer">This Year</a></li>
                        </ul>
                    </div>
